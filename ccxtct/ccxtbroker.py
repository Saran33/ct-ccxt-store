...
from cytrader import BrokerBase, OrderBase, Order
from cytrader.position import Position
from cytrader.utils.py3 import queue, with_metaclass
...
class CCXTBroker(with_metaclass(MetaCCXTBroker, BrokerBase)):
    ...
    Modified getcash() and getvalue():
        cytrader will call getcash and getvalue before and after next, slowing things down
