...
import ccxt
from cytrader.metabase import MetaParams
from cytrader.utils.py3 import with_metaclass
...
class CCXTStore(with_metaclass(MetaSingleton, object)):
    ...
    def get_granularity(self, timeframe, compression):
        ...
        if granularity is None:
            raise ValueError("cytrader CCXT module doesn't support fetching OHLCV "
